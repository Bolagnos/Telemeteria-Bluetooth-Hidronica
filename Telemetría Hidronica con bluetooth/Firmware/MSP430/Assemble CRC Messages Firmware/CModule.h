...
//   int respIDMenu;
   ...
   char ID_UV[5];         // - Unidad Verificadora?
public:
...
//   x=sizeof(*this->sysPass);
  ...
  startDataAddr=dataFlagEEPROMAddr+1;
  this->Mem->writeAddr(logicAddrEEPROM,startDataAddr,0x01,(char*)&this->SysPass,70); // Almacena password de usuario del sistema + RFC + Latitude + Longitude + ID_FM_SM + ID_UV
  startDataAddr+=70;
