...
const char timeLoggerSat[27]={0,15,30,1,2,3,4,6,8,12,24};
...
CLogger::CLogger()
{
  ...
  this->alarmLoggSatActivated=false; // badera de detección de horario de ejecución de la alarma de recolecció para obtener infro del medidor
